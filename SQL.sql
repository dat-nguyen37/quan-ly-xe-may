...
Insert into Qlnhap values(6,2,2,1,'2002-1-1',1000,2000,10,2000)
...
Insert into Qlxuat values(7,1,N'dat','2002-1-1','a',100,2000,10,2000)
select *from Qlhanghoa
	Select *from Qlxuat
...
Insert into Qlxuat values(4,1,'sang','2002-1-1','a',10,2000,10,2000)
...
CREATE TRIGGER tr_capnhatthanhtien ON Qlluong FOR INSERT AS
	...
	Insert into Qlluong values(3,1,1.7,2000000)
