...
namespace Phần_mềm_quản_lý_cửa_hàng_xe_máy
{
    public partial class xuathang : Form
    {
        ...
        private void xuathang_Load_1(object sender, EventArgs e)
        {
            ...
            string con_tr = "Data Source=(local); INitial Catalog=QuanLyXeMay; Integrated Security=SSPI;";
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            if (sosanh <= 0)
            {
                ...
                if (s1 > 0)
                {
                    ...
                    List<model.xemay> data = new List<model.xemay>();
                    string con_tr1 = "Data Source=(local); INitial Catalog=QuanLyXeMay; Integrated Security=SSPI;";
